...
![](https://static.pity.fun/picture/20220612225958.png)

  首先可以看到的是，token已经被替换成功了，接着来我们来确定下`项目`那块。


![](https://static.pity.fun/picture/20220612230117.png)

  这是改造之前的body内容，我们搜下下面的部分（因为RequestInfo打印的时候，是字典的形式，所以顺序比较混乱可能）
  

![](https://static.pity.fun/picture/20220612230805.png)

  所以我这边分了2次打印，替换前后都打印了。可以看到，我们的woody和米洛都被替换成了`登录接口`的response部分。
  
  最后我们来看看replaced里面的内容：

![](https://static.pity.fun/picture/20220612230946.png)
